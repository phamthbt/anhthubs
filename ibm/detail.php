...
if (isset($_SESSION['ibm']) & $_SESSION['ibm']->current_student_id!=''){
	...
	$str .='
		...
		<div >Download:<a href="#"> <img src="../pix/PDF_64x.png" width="35" title="Download PDF"/></a> | Email:<input type="text" name="sendmail"/><a href="#"> <img src="../pix/icon-email.png" width="25"/></a></div>
        </div>';
